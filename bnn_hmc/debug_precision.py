...
def test_precision():
  ...
  prior_diff_np_fn = make_gaussian_prior_difference_numpy(
    weight_decay=args.weight_decay)
  ...
  key, net_init_key, net_init_key2 = jax.random.split(
  ...
  preds_highprec = nn_loss.pmap_get_softmax_preds(net_highprec, params_p,
                                                  test_set, 1)
